...
/** I have absolutely no idea why this doesn't work in the @date-io/dayjs package */
/** Somehow copying the source code here without even modifying it makes it work just fine */
/** ¯\_(ツ)_/¯ */
